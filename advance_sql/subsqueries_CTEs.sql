/* following query relates to subquery
...
SELECT
    ...
    company_job_per_id.total_jobs
FROM
    company_dim 
inner join company_job_per_id on company_job_per_id.company_id=company_dim.company_id
